...
class FpgaTop(Block):
    ...
    def setup(self):
        ...
        self.design_dir = self.src_dir / "fpga"
        self.xdc_in = [
            self.design_dir / "xdc" / "ddr.xdc",
    ...
    def vivado_generate_reports(self, cwd: Path, r: Result, t: Vivado):
        ...
        t.create_waiver(strings="io_wrapper_i/tdo_flop_i", id="TIMING-14", description="Needed for TDO")
